...
dependencies {
    ...
    // NOT: me.jahnen.libaums:storageprovider Maven Central'da bu surumle
    // bulunamadigi icin kaldirildi (SAF entegrasyonu opsiyoneldi, cekirdek
    // islevsellik -- dosya yonetimi, format, hiz testi, ISO yazma -- bu
    // modul olmadan tamamen calisir).
